...
if __name__ == '__main__':
    if not os.path.exists(train_cfg['basic']['logger_dir']):
        os.makedirs(train_cfg['basic']['logger_dir'])
    if not os.path.exists(train_cfg['basic']['checkpoint_dir']):
        os.makedirs(train_cfg['basic']['checkpoint_dir'])
    train_net(train_cfg)